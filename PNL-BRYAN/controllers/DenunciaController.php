...
class DenunciaController
{
    ...
    {
        $items_per_page = 5; // Número de denuncias por página
        $current_page = isset($_GET['page']) ? (int)$_GET['page'] : 1;
        $offset = ($current_page - 1) * $items_per_page;

        // Obtener las denuncias paginadas y el total de denuncias
        $result = $this->denunciaModel->getDenunciasPaginated($offset, $items_per_page);
        $total_items = $this->denunciaModel->getTotalDenuncias();
