...
class Denuncia
{
    ...
    public function getDenunciasPaginated($offset, $items_per_page)
    {
        $query = "SELECT * FROM denuncias LIMIT :offset, :items_per_page";
    ...
    {
        $query = "SELECT COUNT(*) as count FROM denuncias";
